...
class ItemBasketPage extends StatefulWidget {
  ...
  @override
  State<ItemBasketPage> createState() => _ItemDetailsPageState();
}

class _ItemDetailsPageState extends State<ItemBasketPage> {
  List<Product> basketList = [
    Product(
      productNo: 1,
      productName: "노트북(Lapto)",
        ...
        body: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return basketContainer(
                ...
                quantity:
                    quantityList[index][basketList[index].productNo] ?? 0);
          },
        ),
